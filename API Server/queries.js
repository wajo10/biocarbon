    ...
    switch (box) {
        ...
        case "N":
            switch (sensor) {
                ...
                case "sensor2":
                    return (humidity ** 2 * 5 * 10 ** -8 + humidity * -0.0041 + 93.144)
                case "sensor3":
                    return (390.4 * Math.E ** (-0.00009 * humidity))
                case "sensor4":
        ...
        case "O":
            switch (sensor) {
                ...
                case "sensor3":
                    return (humidity ** 2 * 3 * 10 ** -8 + humidity * -0.0036 + 118.34)
                case "sensor4":
                    return (humidity ** 2 * 5 * 10 ** -8 + humidity * -0.0053 + 142.78)
                case "sensor5":
